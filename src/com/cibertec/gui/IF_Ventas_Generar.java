...
import com.cibertec.util.DatosAplicacion;
...
public class IF_Ventas_Generar extends JInternalFrame {
    ...
    public void leerTablaVenta() {
    	
    	// leer Jtable 
    	// avanzar esto 
    	
    	String codigoVenta = lblNumeroVenta.getText();
    	String codigoCliente= txtClienteCod.getText();
    	int cantidadFila = table.getRowCount();
    	...
    	for(int i=0; i<cantidadFila; i++) {
    		...
    		objVenta.setCodigoVenta(Integer.parseInt(codigoVenta));
    		objVenta.setCodigoCliente(Integer.parseInt(codigoCliente));
    		objVenta.setCodigoProducto(Integer.parseInt(table.getValueAt(i, 1).toString()));
    		objVenta.setCantidad(Integer.parseInt(table.getValueAt(i, 3).toString()));
    		objVenta.setPrecio(Double.parseDouble(table.getValueAt(i, 4).toString()));
    		objVenta.setFecha(getFecha());
    		arregloVentas.agregar(objVenta);
    	}
